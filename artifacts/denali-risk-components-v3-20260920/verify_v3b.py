"""Text-level checks on the rendered v3b PDFs: no retired headings, no book leakage."""
...
DOCS = {
    'Denali_Risk_Dial_Detailed_v3b': {'pages': 4, 'need': ['NYSE Net Highs',
                                                           'Proposed dual filter: evaluated, not adopted']},
    'Denali_Risk_Dial_One_Page_v3b': {'pages': 1, 'need': []},
}
