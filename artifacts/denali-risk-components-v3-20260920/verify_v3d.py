"""Text-level checks on the rendered v3d PDFs: no retired headings, no book leakage.

Every v3c check, plus the wording the move from 50 to 55 has to leave behind and
the heading it has to introduce.
"""
...
DOCS = {
    'Denali_Risk_Dial_Detailed_v3d': {'pages': 3, 'need': ['NYSE Net Highs', 'Why 55 matters']},
    'Denali_Risk_Dial_One_Page_v3d': {'pages': 1, 'need': []},
}
TITLE = 'Denali Risk Dial'
# Text that must appear somewhere in the document (not necessarily as a heading).
REQUIRED = {'Denali_Risk_Dial_Detailed_v3d': ['Why 55 matters', 'Below 55', '55 or above'],
            'Denali_Risk_Dial_One_Page_v3d': ['55 or above']}
