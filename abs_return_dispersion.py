...
SP500_TICKERS = [
    ...
    "BIO", "BNY", "BKNG", "BKR", "BLDR", "BLK", "BMY", "BR", "BRK-B", "BRO",
    "BSX", "BWA", "BX", "BXP",
    ...
    "CRL", "CRM", "CRWD", "CSCO", "CSGP", "CSX", "CTAS", "CTLT", 
    ...
    "MET", "META", "MGM", "MHK", "MKC", "MKTX", "MLM", "MRSH", "MMM", "MNST",
    ...
    "ROP", "ROST", "RSG", "RTX",
    "SBAC", "SBUX", "SCHW", "SHW", "SIVB", "SJM", "SLB", "SMCI",
