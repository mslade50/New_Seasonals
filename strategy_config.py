...
_STRATEGY_BOOK_RAW = [
    ...
    {
        "id": "5d < 10%ile+10d < 10%ile+21d < 10%ile, 3 dist > in 21d, SPY 21d > 30%ile, Entry: Signal Close, 5d hold",
        "name": "Deep Oversold",
        "setup": {
            "type": "MeanReversion",
            "timeframe": "Swing",
            ...
            "key_filters": [
                ...
                "10D rank < 10th %ile",
                "21D rank < 10th %ile",
                "Has NOT made 52w low in last 21 days",
                "10D vol rank > 90th %ile",
                "Dist days > 3 in last 21d",
                "SPY 21D rank > 30th %ile"
            ]
        },
        "exit_summary": {
            "primary_exit": "Target, Stop, or 5-day time stop",
            "stop_logic": "2.0 ATR below entry",
            "target_logic": "1.0 ATR above entry",
            "notes": None
        },
        "description": "Backtest: 2000-01-01 to present. Tested on 198 tickers.",
        "universe_tickers": LIQUID_PLUS_COMMODITIES,
        "settings": {
            "trade_direction": "Long",
            "entry_type": "Signal Close",
            ...
            "use_recent_52w_low": True, "recent_52w_low_invert": True, "recent_52w_low_lookback": 21,
            "breakout_mode": "None",
            ...
            "min_price": 10.0, "min_vol": 100000,
            "min_age": 0.25, "max_age": 100.0,
            "min_atr_pct": 1.0, "max_atr_pct": 10.0,
            "use_dow_filter": False, "allowed_days": [0, 1, 2, 3, 4],
            "allowed_cycles": [1, 2, 3, 0],
            "use_ref_ticker_filter": True, "ref_ticker": "SPY", "ref_filters": [{"window": 21, "logic": ">", "thresh": 30.0}],
        ...
        "stats": {"grade": "A (Excellent)", "win_rate": "64.4%", "expectancy": "0.10r", "profit_factor": "1.59"}
    },
    {
        "id": "2d < 15%ile+5d < 15%ile+10d < 15%ile+21d < 15%ile+126d > 65%ile+252d > 65%ile, XSec 252d > 50%ile, Entry: Signal Close, 2d hold",
        "name": "LT Trend ST OS",
        "setup": {
            "type": "MeanReversion",
            "timeframe": "Overnight",
            "thesis": "Oversold bounce setup — buying short-term weakness in names with strong long-term trend",
            "key_filters": [
                "2D rank < 15th %ile",
                "5D rank < 15th %ile",
                "10D rank < 15th %ile",
        ...
        "description": "Start: 2000-01-01. Universe: Liquid+Commodities. Dir: Long. PF: 2.30. SQN: n/a.",
        "universe_tickers": LIQUID_PLUS_COMMODITIES,
        "settings": {
            "trade_direction": "Long",
            "entry_type": "Signal Close",
            ...
            "entry_conf_bps": 0,
            "perf_filters": [
                {'window': 2, 'logic': '<', 'thresh': 15.0, 'consecutive': 1},
                {'window': 5, 'logic': '<', 'thresh': 15.0, 'consecutive': 1},
                {'window': 10, 'logic': '<', 'thresh': 15.0, 'consecutive': 1},
                {'window': 21, 'logic': '<', 'thresh': 15.0, 'consecutive': 1},
            ...
            "use_atr_ret_filter": False, "atr_ret_min": -10.0, "atr_ret_max": -0.2,
            "use_range_atr_filter": False, "range_atr_logic": ">", "range_atr_min": 1.0, "range_atr_max": 3.0,
            "price_action_filters": [],
            "use_ma_dist_filter": False, "dist_ma_type": "SMA 10", "dist_logic": "Greater Than (>)", "dist_min": 0.0, "dist_max": 2.0,
            "use_weekly_ma_pullback": False, "wma_type": "EMA", "wma_period": 8,
            ...
            "use_t1_open_filter": False, "t1_open_filters": [],
            "use_xsec_filter": True, "xsec_filters": [{'window': 252, 'logic': '>', 'thresh': 50.0, 'consecutive': 1}]
        },
        "execution": {
            "risk_bps": 35,
            "risk_per_trade": "[EDIT: calculated from account size]",
        ...
        "stats": {"grade": "A (Excellent)", "win_rate": "65.8%", "expectancy": "0.31r", "profit_factor": "2.30"}
    },
]
