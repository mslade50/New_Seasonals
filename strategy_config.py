...
_STRATEGY_BOOK_RAW = [
    ...
    {
        "id": "5d+10d+21d < 10%ile, vol rank > 90, below 200d, 5d hold",
        ...
        "stats": {"grade": "A (Excellent)", "win_rate": "64.7%", "expectancy": "0.39r", "profit_factor": "1.96"}
    },
    {
    ...
    {'id': '2d < 50%ile+5d < 10%ile+10d < 10%ile+21d < 10%ile, 3 dist > in 21d, > risind 200d, Entry: Limit (Open +/- 0.5 ATR) GTC, 5d hold',
     'name': 'Deep Oversold Uptrend',
     'setup': {'type': 'MeanReversion',
               'timeframe': 'Swing',
               'thesis': 'Oversold bounce setup in uptrending names',
               'key_filters': ['2D rank < 50th %ile',
                               '5D rank < 10th %ile',
                               '10D rank < 10th %ile',
                               '21D rank < 10th %ile',
                               '10D vol rank > 85th %ile',
                               'Dist days > 3 in last 21d',
                               'Trend: Price > Rising 200 SMA',
                               'VIX between 0-33']},
     'exit_summary': {'primary_exit': 'Target or 5-day time stop',
                      'stop_logic': 'None (time exit only)',
                      'target_logic': '2.0 ATR above entry',
                      'notes': None},
     ...
     'execution': {'risk_bps': 35,
                   ...
                   'use_stop_loss': False,
                   'use_take_profit': True},
     'stats': {'grade': 'A (Excellent)', 'win_rate': '70.1%', 'expectancy': '0.61r', 'profit_factor': '3.04'}},
]
