...
Last night's brief found the 2026-08-31 grain/softs bars were 94-98% overnight
gap. KC=F printed -10.34% tonight and the three grains all closed AT 52-week
highs. Gate every commodity verdict in the cell map on this.
"""
import sys
