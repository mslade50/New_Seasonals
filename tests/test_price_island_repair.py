...
def _run_main(monkeypatch, tmp_path, argv):
    ...
    # Freeze the updater's clock so the 120-calendar-day fetch floor always
    # includes the full planted 12-session island. Without this seam the test
    # loses one expected row each day after 2026-09-04 while production
